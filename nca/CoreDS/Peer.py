...
class PeerSet(set):
    ...
    def get_peer_set_by_indices(self, peer_interval_set):
        ...
        :param CanonicalIntervalSet peer_interval_set: the interval set of indices into the sorted peer list
        :return: the PeerSet containing peers referenced by the indices in the interval set
        """
        my_len = len(self)
