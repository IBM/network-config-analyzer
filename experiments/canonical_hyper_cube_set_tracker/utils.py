...
def _long_path_error_example():
    file = '/experiments\\canonical_hyper_cube_set_tracker\\traces\\tests\\calico_testcases\\example_policies\\testcase19-profiles\\testcase19-sanity_np8-0-cnc-fe-bewteen-namespaces-namespaceSelector-without-opening-egress.trace'
    file = Path(file)
