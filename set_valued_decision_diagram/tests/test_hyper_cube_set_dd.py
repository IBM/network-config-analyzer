...
from set_valued_decision_diagram.hyper_cube_set_dd import HyperCubeSetDD as CanonicalHyperCubeSet
...
class TestCanonicalHyperCubeSetMethods(unittest.TestCase):
    ...
    @unittest.skip('method is not supported.')
    ...
    @unittest.skip('method not supported.')
