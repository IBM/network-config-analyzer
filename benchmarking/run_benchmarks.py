...
def _get_logger(experiment_name: str, to_file=True):
...
def run_benchmarks(experiment_name: str, example_benchmark_only: bool = False, tests_only: bool = False,
    ...
    logger = _get_logger(experiment_name, to_file=False)    # TODO: change flag to log into a file.
    ...
    for i, benchmark in enumerate(benchmark_list, 1):
        try:
            ...
            # TODO: if a benchmark throws an exception (with tracking) than catch the exception, print it, and continue.
            #   count how many benchmarks we pass and which we don't.
