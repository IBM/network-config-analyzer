...
class TestCanonicalHyperCubeSetMethodsNew(unittest.TestCase):
    ...
    '''
    # TODO: exponential complexity example below..
    ...
    def test_basic_3(self):
        ...
        z = CanonicalHyperCubeSet(dimensions, True)
        methods_dfa1 = dim_manager.get_dimension_domain_by_name("methods") - get_str_dfa("PUT")
        methods_dfa2 = get_str_dfa("PUT")
        x.add_cube([methods_dfa1], ["methods"])
        y.add_cube([methods_dfa2], ["methods"])
        w = x | y
        self.assertEqual(x.active_dimensions, ["methods"])
        self.assertEqual(y.active_dimensions, ["methods"])
    ...
    def test_len_basic(self):
        ...
        empty = CanonicalHyperCubeSet(dimensions)
        x1 = empty.copy()
        x1.add_cube([get_str_dfa("PUT")], ["methods"])
        x2 = empty.copy()
        x2.add_cube([get_str_dfa("b")], ["paths"])
        x2.add_cube([get_str_dfa("PUT")], ["methods"])
        # print(x1)
        # print(x2)
    ...
    def test_hash_basic(self):
        ...
        x1 = empty1.copy()
        x1.add_cube([get_str_dfa("GET")], ["methods"])
        not_x1 = all1 - x1
        empty2 = x1 - x1
        all2 = not_x1 | x1
    ...
    def test_canonical_rep_dfa_new(self):
        ...
        dfa5 = get_str_dfa("PUT")
        dfa6 = get_str_dfa("CONNECT")

        x = CanonicalHyperCubeSet(dimensions)
        y = CanonicalHyperCubeSet(dimensions)

        x.add_cube([dfa4, dfa1], ["methods", "paths"])
        # print(f'x1: {x}')
        x.add_cube([dfa5, dfa2], ["methods", "paths"])
        # print(f'x2: {x}')
        x.add_cube([dfa6, dfa3], ["methods", "paths"])
        # print(f'x3: {x}')
        # print(x)

        y.add_cube([dfa5, dfa2], ["methods", "paths"])
        # print(f'y1: {y}')
        y.add_cube([dfa6, dfa3], ["methods", "paths"])
        # print(f'y2: {y}')
        y.add_cube([dfa4, dfa1], ["methods", "paths"])
        # print(f'y3: {y}')
        # print(y)
        self.assertEqual(x, y)
    ...
    def test_canonical_rep_dfa_new_1(self):
        ...
        dfa4 = get_str_dfa("GET")
        dfa5 = get_str_dfa("PUT")
        dfa6 = get_str_dfa("CONNECT|GET|PUT")
    ...
    def test_canonical_rep_dfa_new_2(self):
        ...
        dfa1_s = get_str_dfa("GET")
        dfa2 = get_str_dfa("b[b]+")
        dfa2_s = get_str_dfa("PUT")
        dfa3 = get_str_dfa("a|b")
        dfa3_s = get_str_dfa("GET|PUT")
        x = CanonicalHyperCubeSet(dimensions)
        x.add_cube([dfa1_s, dfa1], ["methods", "paths"])
        x.add_cube([dfa2_s, dfa2], ["methods", "paths"])
        x.add_cube([dfa3_s, dfa3], ["methods", "paths"])
        # print(x)

        dfa4 = get_str_dfa("[a]+|b")
        dfa4_s = get_str_dfa("GET")
        dfa5 = get_str_dfa("[b]+|a")
        dfa5_s = get_str_dfa("PUT")
        y = CanonicalHyperCubeSet(dimensions)
        y.add_cube([dfa4_s, dfa4], ["methods", "paths"])
        y.add_cube([dfa5_s, dfa5], ["methods", "paths"])
        # print(y)
        self.assertEqual(x, y)
    ...
    def test_empty_dfa_new(self):
        ...
        m.add_cube([methods_dfa], ["methods"])
        m.add_hole([methods_dfa2], ["methods"])
    ...
    def test_add_cube_new(self):
        ...
        x = CanonicalHyperCubeSet(dimensions)
        x.add_cube([methods_dfa1, paths_dfa], ["methods", "paths"])
        self.assertEqual(1, len(x))
        x.add_cube([methods_dfa2, paths_dfa], ["methods", "paths"])
        self.assertEqual(1, len(x))
        p = CanonicalIntervalSet.get_interval_set(500, 600)
        y = CanonicalHyperCubeSet(dimensions)
        y.add_cube([p, methods_dfa1, paths_dfa], ["ports", "methods", "paths"])
        y.add_cube([p, methods_dfa2, paths_dfa], ["ports", "methods", "paths"])
    ...
    def test_add_cube(self):
        ...
        methods_dfa = get_str_dfa("PUT")
        x.add_cube([ports_range3, methods_dfa], ["ports", "methods"])
        x_expected_cubes = [
        ...
        x_expected_cubes = {
            ...
            tuple([range1, range3, dim_manager.get_dimension_domain_by_name("methods"), dim_manager.get_dimension_domain_by_name("paths")]),
            tuple([range1, range4, methods_dfa_all_but_put, dim_manager.get_dimension_domain_by_name("paths")]),
            tuple([ports_range, range5, dim_manager.get_dimension_domain_by_name("methods"), dim_manager.get_dimension_domain_by_name("paths")]),
            tuple([ports_range, ports_range4, methods_dfa_all_but_put, dim_manager.get_dimension_domain_by_name("paths")]),
    ...
    def test_eq(self):
        ...
        y.add_cube([ports_range,  get_str_dfa("GET")], ["ports", "methods"])
        ...
        y.clear()
        y.active_dimensions = ["ports", "methods"]
        y.add_cube([ports_range,  get_str_dfa("PUT")], ["ports", "methods"])
    ...
    def test_operators_basic(self):
        ...
        empty = CanonicalHyperCubeSet(dimensions)
        x1 = empty.copy()
        x1.add_cube([get_str_dfa("abc")], ["methods"])
        res1 = all & x1
        ...
        x5 = x1.copy()
        x5.add_cube(short_all_space_cube, ["methods"])
    ...
    def test_subtract_new(self):
        ...
        res_cube_2 = (dim_manager.get_dimension_domain_by_name("methods") - methods_dfa, dim_manager.get_dimension_domain_by_name("paths"))
    ...
    def test_basic_and(self):
        ...
        x1.add_cube([paths_dfa, paths_dfa], ["methods", "paths"])
        y1.add_cube([paths_dfa_new, paths_dfa_new], ["methods", "paths"])
        z1 = x1 & y1
    ...
    def test_add_hole_basic(self):
        ...
        x.add_cube([methods_dfa_2, paths_dfa2], ["methods", "paths"])  # (y|m, abcd)
        res1 = {(get_str_dfa("y|m"), get_str_dfa("abcd"))}
        self.assertEqual(x._get_cubes_set(), res1)
        # print(x)
        x.add_cube([methods_dfa_1, paths_dfa_new], ["methods", "paths"])  # (x|m, abc)
        ...
        x.add_hole([methods_dfa_1, paths_dfa], ["methods", "paths"])
        # print(x)
    ...
    def test_add_cube_dfa_basic_3(self):
        ...
        self.assertEqual(x._get_cubes_set(), res1)
        x.add_cube([methods_dfa_2, paths_dfa2], ["methods", "paths"])  # (y, abcd)
        res2 = {(get_str_dfa("PUT"), get_str_dfa("abc|abcd")),
                (dim_manager.get_dimension_domain_by_name("methods") - get_str_dfa("PUT"), get_str_dfa("abc"))}
        self.assertEqual(x._get_cubes_set(), res2)
        # print(x)
    ...
    def test_add_cube_dfa_basic_2(self):
        ...
        x.add_cube([methods_dfa_1, paths_dfa], ["methods", "paths"])  # (x, abc)
        # print(x)
    ...
    def test_basic_new(self):
        ...
        c.add_cube([get_str_dfa("PUT"), get_str_dfa("a")], ["methods", "paths"])
        c.add_cube([get_str_dfa("GET"), get_str_dfa("p")], ["methods", "paths"])
        c.add_cube([get_str_dfa("GET"), get_str_dfa("[p]*")], ["methods", "paths"])
        d = CanonicalHyperCubeSet(dimensions)
        d.add_cube([get_str_dfa("GET"), get_str_dfa("pp")], ["methods", "paths"])
        d.add_cube([get_str_dfa("GET"), get_str_dfa("[p]*")], ["methods", "paths"])
        d.add_cube([get_str_dfa("PUT"), get_str_dfa("a")], ["methods", "paths"])
        ...
        b.add_cube([get_str_dfa("p"), get_str_dfa("GET")], ["methods", "paths"])
        b.add_cube([get_str_dfa("[p]*"), get_str_dfa("PUT")], ["methods", "paths"])
        # print(b)
        ...
        g.add_cube([get_str_dfa("PUT"), get_str_dfa("b"), get_str_dfa("c")], ["methods", "paths", "hosts"])
        g.add_cube([get_str_dfa("PUT"), get_str_dfa("e"), get_str_dfa("c")], ["methods", "paths", "hosts"])
        res3 = [[get_str_dfa("PUT"), get_str_dfa("b|e"), get_str_dfa("c")]]
        ...
        b = CanonicalHyperCubeSet(dimensions)
        c = CanonicalHyperCubeSet(dimensions)
        a.add_cube([get_str_dfa("PUT"), get_str_dfa("a")], ["methods", "paths"])
        self.assertEqual(a & a, a)
        b.add_cube([get_str_dfa("PUT"), get_str_dfa("a")], ["methods", "paths"])
        b.add_cube([get_str_dfa("GET"), get_str_dfa("b")], ["methods", "paths"])
        self.assertEqual(a & b, a)
        self.assertNotEqual(a, b)
        c.add_cube([get_str_dfa("PUT|GET"), get_str_dfa("a|b")], ["methods", "paths"])
        self.assertEqual(a & c, a)
        self.assertEqual(b & c, b)
        a = CanonicalHyperCubeSet(dimensions)
        b = CanonicalHyperCubeSet(dimensions)
        a.add_cube([get_str_dfa("PUT"), get_str_dfa("a")], ["methods", "paths"])
        a.add_cube([get_str_dfa("PUT"), get_str_dfa("b")], ["methods", "paths"])
        b.add_cube([get_str_dfa("PUT|GET"), get_str_dfa("a|b")], ["methods", "paths"])
        self.assertTrue(a.contained_in(b))
        ...
        a.add_cube([get_str_dfa("PUT"), get_str_dfa("a")], ["methods", "paths"])
        a.add_cube([get_str_dfa("PUT"), get_str_dfa("b")], ["methods", "paths"])
        c.add_cube([get_str_dfa("GET"), get_str_dfa("a")], ["methods", "paths"])
        c.add_cube([get_str_dfa("GET"), get_str_dfa("b")], ["methods", "paths"])
        b.add_cube([get_str_dfa("PUT|GET"), get_str_dfa("a|b")], ["methods", "paths"])
...
class TestCanonicalHyperCubeSetMethodsIntervalsNew(unittest.TestCase):
    def test_basic(self):
