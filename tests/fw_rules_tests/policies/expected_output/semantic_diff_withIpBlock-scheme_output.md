...
|||ip block: 0.0.0.0/5|[kube-system]|[tier in (frontend)]|All but UDP dst_ports: (53, ),|
|||ip block: 11.0.0.0/8|[kube-system]|[tier in (frontend)]|All but UDP dst_ports: (53, ),|
|||ip block: 172.22.0.0/15|[kube-system]|[tier in (frontend)]|All but UDP dst_ports: (53, ),|
|||ip block: 172.31.0.0/16|[kube-system]|[tier in (frontend)]|All but UDP dst_ports: (53, ),|
